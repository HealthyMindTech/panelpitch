...
import { ChatMessage, Advisor, AdvisorStatus } from '../models/advisor';
...
const Advisors = ({advisorStatus, pitch}: {advisorStatus: Record<string, AdvisorStatus>, pitch: string}) : JSX.Element => {
